...
module "container_definitions" {
  source = "./modules/container-definitions"

  environment           = var.environment
  aws_region           = var.aws_region
  log_group_name       = module.ecs.devlake_log_group_name
...
module "ecs" {
  ...
  container_ports           = var.container_ports
  devlake_task_definition_arn = module.container_definitions.devlake_task_definition_arn
  grafana_task_definition_arn = module.container_definitions.grafana_task_definition_arn
  config_ui_task_definition_arn = module.container_definitions.config_ui_task_definition_arn
